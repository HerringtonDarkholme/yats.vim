...
syntax region typescriptTernary matchgroup=typescriptTernaryOp start=/?\@1<!?[.?]\@!/ end=/:/ contained contains=@typescriptValue,@typescriptComments nextgroup=@typescriptValue skipwhite skipempty
