...
syntax keyword javascriptBOMWindowMethod alert atob blur btoa clearImmediate clearIntervalnextgroup=javascriptFuncArg
syntax keyword javascriptBOMWindowMethod clearTimeout close confirm dispatchEventnextgroup=javascriptFuncArg
syntax keyword javascriptBOMWindowMethod dump find focus getAttention getAttentionWithCycleCountnextgroup=javascriptFuncArg
syntax keyword javascriptBOMWindowMethod getComputedStyle getDefaulComputedStyle getSelectionnextgroup=javascriptFuncArg
syntax keyword javascriptBOMWindowMethod matchMedia maximize moveBy moveTo open openDialognextgroup=javascriptFuncArg
syntax keyword javascriptBOMWindowMethod postMessage print prompt removeEventListenernextgroup=javascriptFuncArg
syntax keyword javascriptBOMWindowMethod resizeBy resizeTo restore scroll scrollBynextgroup=javascriptFuncArg
syntax keyword javascriptBOMWindowMethod scrollByLines scrollByPages scrollTo setCursornextgroup=javascriptFuncArg
syntax keyword javascriptBOMWindowMethod setImmediate setInterval setResizable setTimeoutnextgroup=javascriptFuncArg
syntax keyword javascriptBOMWindowMethod showModalDialog sizeToContent stop updateCommandsnextgroup=javascriptFuncArg
